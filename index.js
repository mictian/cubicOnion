...
,	incrementalDOMAdapter = require('./lib/Adapters/incrementalDOMAdapter')
,	compositeViewPlugin = require('./lib/defaultPlugins/compositionViews')
,	local_parser = new codeGenerator();
...
,	generateVirtualDOM: function (string_html, options)
	{
		...
		options.adapter = options.adapter || incrementalDOMAdapter;
