...
// This file contains the code that handle extra handlebars helpers. Like every time we use {{#customHelper param1 param2}}
...
module.exports = {
	...
	//@method runtimeGenericSingleHandle This method converts passed in function that represent extra helpers to string in a safe way
	//@param {CodeGenerationContext} code_generation_context
	...
	runtimeGenericSingleHandle: function (code_generation_context)
	{
		...
		{
			return code_generation_context.adapter.defineTextTag.call(code_generation_context.adapter, code_generation_context, result);
		}
	},
