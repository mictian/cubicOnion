...
htmlNode
	//@class OpenHTMLNodeASTNode @extends HTMLNodeASTNode
	= ignorable* '<' !"!--" !"input" !voidElement tagName:word ignorable* attrs:(attributes)? ignorable* !"/" ">" ignorable*
		{
			return {
	...
	//@class VoidHTMLNodeASTNode @extends HTMLNodeASTNode
//	/ ignorable* "<" !"!--" tagName:(voidElement/"input") ignorable* attrs:(attributes)? ignorable* "/"? ">"
	...
	//@class CloseHTMLNodeASTNode @extends HTMLNodeASTNode
	/ ignorable* "</" ignorable* !'input' tagName:word ignorable* attrs:(attributes)? ignorable* ">" ignorable*
		{
			return {
	...
	//@class CommentHTMLNodeASTNode @extends HTMLNodeASTNode
	...
	//Input are handle independently as they accept both notations, as a void element and as a standard element !
	/	ignorable* '<input' ignorable* attrs:(attributes)? ignorable* '>' ns:node* '</input>'
		{
			return [
				{
					type: 'htmlOpenNode'
	...
	/	ignorable* '<input' ignorable* attrs:(attributes)? ignorable* '/'? '>'
		{
			return {
				type: 'htmlVoidNode'
			,	tag: 'input'
...
handlebarsGenericBlock
	= '{{#' space* openTagName:word space* params:(params)? space* "}}" ignorable* children:(nodes)? ignorable* "{{/" closeTagName:word "}}"
		{
			return {
				//@property {String} type Value 'handlebars'
				type: 'handlebars'
...
handlebarsSafeGenericSingle
	= "{{" !"." !"!--" space* w:word space+ ps:params space* "}}"
		{
			return {
				//@property {String} type Value 'handlebars'
				type: 'handlebars'
...
attributeSimpleValueWrapperSingleQuote
	= "'" spaces:ignorable* values:attributeSimpleValuesSingleQuote "'"
		{
...
attributeSimpleValueWrapperDoubleQuote
 	= "\"" spaces:ignorable*  values:attributeSimpleValuesDoubleQuote "\""
		{
			return concatSortedSpaces(spaces, values);
			// return values;
		}
